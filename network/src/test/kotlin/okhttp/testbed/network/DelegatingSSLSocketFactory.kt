 ...
 *
 * Copied from OkHttp's `okhttp-testing-support`, which is not published. Overriding TLS parameters
 * from outside OkHttp is the point of the suites that use this, so the copy is what keeps them
 * running against an arbitrary release.
 */
